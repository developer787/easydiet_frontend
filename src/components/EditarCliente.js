...
class NewCustomerForm extends React.Component {
  constructor(props) {
    super(props)
    this.state = {id : 0, alergias: [], formStatus: 'default', ul: 'aligned', response: {}}
  ...
  componentDidMount(){
    const {_id, nombre, apellido, alergias } = this.props.location.customer
    const payload = {_id, nombre, apellido, alergias }
    console.log(payload)
    this.setState(payload)
    alergias.map(e=>this.selectedCheckboxes.add(e))
  }
